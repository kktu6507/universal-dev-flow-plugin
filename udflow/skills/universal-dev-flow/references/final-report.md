...
- the **`### Live run` block** below — paste it into the project's `EVIDENCE.md` *Real-world runs* section (or a PR that adds that section), and into the [`Verified udflow run`](https://github.com/kktu6507/universal-dev-flow-plugin/issues/new?template=verified-run.yml) issue form's **The run** box;
...
- Keep this list in sync with [`.github/ISSUE_TEMPLATE/verified-run.yml`](https://github.com/kktu6507/universal-dev-flow-plugin/blob/master/.github/ISSUE_TEMPLATE/verified-run.yml) — that form is the source of truth for the fields and options.
